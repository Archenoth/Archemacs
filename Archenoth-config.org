...
#+BEGIN_SRC emacs-lisp
  ...
  (check-packages 'pp-c-l 'multiple-cursors 'web-mode 'rsense 'robe
   'projectile 'plsql 'php-mode 'paredit 'yasnippet 'markdown-mode+
   'magit 'lua-mode 'langtool 'js2-refactor 'jedi 'htmlize
   'helm-projectile 'helm-emmet 'grizzl 'graphviz-dot-mode
   ...
   'ac-js2 'ac-emmet 'ac-cider 'tern-auto-complete
   'org-plus-contrib)
#+END_SRC
