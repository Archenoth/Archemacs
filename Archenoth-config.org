...
After that, I want to make an advised version of =display-buffer=,
because I really dislike having windows pop up when I am in fullscreen
mode.
...
Now, of course, there is the initialization code I have at
=<<toggle-style-initialization>>=:
